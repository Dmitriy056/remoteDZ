...
Для того, чтобы начать работу со своим удаленным репозиторием необходимо создать файл `readme.md` (стандартный информационный файл). После того, как мы создали файл его необходимо добавить в отслеживаемый командой `**git add**` 